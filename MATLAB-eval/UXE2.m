             ...
             if Flag_plot_veh
                ...
                for i = 1 : length(path(:,1))
                     if ~(path(i,1) == 0 && path(i,2) == 0 && path(i,3) == 0 && path(i,4) == 0 && path(i,5) == 0)
                        ...
                        rect_y=-wid/4;
                        center_x5 = (rect_x+3*offset-0.3) * cosphi - (rect_y+0.33) * sinphi + cpx;
                        center_y5 = (rect_x+3*offset-0.3) * sinphi + (rect_y+0.33) * cosphi + cpy;
                        center_x6 = (rect_x+offset-0.1) * cosphi - (rect_y+0.2) * sinphi + cpx;
                        center_y6 = (rect_x+offset-0.1) * sinphi + (rect_y+0.2) * cosphi + cpy;
                        center_x7 = (rect_x-offset+0.1) * cosphi - (rect_y+0.2) * sinphi + cpx;
                        center_y7 = (rect_x-offset+0.1) * sinphi + (rect_y+0.2) * cosphi + cpy;
                        center_x8 = (rect_x-3*offset+0.3) * cosphi - (rect_y+0.33) * sinphi + cpx;
                        center_y8 = (rect_x-3*offset+0.3) * sinphi + (rect_y+0.33) * cosphi + cpy;
