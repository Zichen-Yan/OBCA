...
char road_find_seven(double x_now, double y_now, double theta_now, double x_aim, double y_aim, double theta_aim, double car_r_limit, double road_yaw[8], double road_yaw2[8])
{
	...
	if (ErrorCode == 0)
	{
		...
		road_yaw[1] = path_seven.t * rmin;
		road_yaw[3] = path_seven.u * rmin;
		road_yaw[5] = path_seven.v * rmin;
	...
	else
	{
		...
		for (int index_D_seven = D_seven; index_D_seven > 0; index_D_seven--)
		{
			...
			if (ErrorCode == 0)
			{
				...
				road_yaw_sevenimag[3] = path_seven.t * rmin;
				road_yaw_sevenimag[5] = path_seven.u * rmin;
				road_yaw_sevenimag[7] = path_seven.v * rmin;
				path_seven.lenth = path_seven.lenth * rmin;
			}
...
int  dynamic_vertical(double Start1[3], double End1[3])
{
	...
	//C-S-
	int roadsecond = 1;
	roadsecond = road_find_three_cs(Start[0], Start[1], Start[2] * 180 / M_PI, End[0], End[1], End[2] * 180 / M_PI, R_V, 0.03, road_yaw);
	if (roadsecond == 0)
	{
	...
	//C+S-
	int roadfourth = 1;
	roadfourth = road_find_four(Start[0], Start[1], Start[2] * 180 / M_PI, End[0], End[1], End[2] * 180 / M_PI, R_V, 0, road_yaw);
	if (roadfourth == 0)
	{
