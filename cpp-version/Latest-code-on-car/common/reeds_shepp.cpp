...
namespace byd_apa_plan
{
		...
		double car_r_limit, double road_yaw[6], double road_yaw2[6])
	{
		...
		RsPath path_six;
		double x1_six = x1 / rmin_vertical;
		double y1_six = y1 / rmin_vertical;
		//int ErrorCode = 100;
		int theta_car = 0;
		if (fusion.ParkInMode == 1)
		{
		...
		if (CpCmSm(x1_six, y1_six, ph, path_six, theta_car))
		{
			for (int index_six_CCS = 0; index_six_CCS < 3; index_six_CCS++)
			{
				...
				{
					road_yaw[index_six_CCS * 2] = rmin_vertical;
				}
			...
			road_yaw[1] = path_six.t * rmin_vertical;
			road_yaw[3] = path_six.u * rmin_vertical;
			road_yaw[5] = path_six.v * rmin_vertical;
			path_six.lenth = path_six.lenth * rmin_vertical;
