...
int  dynamic_Oblique(double Start1[3], double End1[3])
{
	...
	//C-S-
	int roadsecond = 1;
	roadsecond = road_find_three_cs_Oblique(Start[0], Start[1], Start[2] * 180 / pi, End[0], End[1], End[2] * 180 / pi, R_V, 0.03, road_yaw);
	if (roadsecond == 0)
	{
	...
	//C+S-
	int roadfourth = 1;
	roadfourth = road_find_four_Oblique(Start[0], Start[1], Start[2] * 180 / pi, End[0], End[1], End[2] * 180 / pi, R_V, 0, road_yaw);
	if (roadfourth == 0)
	{
