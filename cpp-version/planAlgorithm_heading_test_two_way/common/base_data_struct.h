...
namespace byd_apa_plan
{
	...
	struct CurrentParkInfo 
	{
		ParkingSpaceInfo CurrentPark;
		double Angle;
	};
    ...
    public:
        ...
        Smoother(const VehicleParam Vehicle_config, std::vector<PathPoint> warm_start);
        ~Smoother(){};
        casadi::Function GetKinematicEquation();
        casadi::Function Kinematic;
