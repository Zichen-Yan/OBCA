...
namespace byd_apa_plan
{
	...
	*/
	...
	void handle_message_test_subscriber_app_currentpark(const boost::shared_ptr<bclcpp::Message> message)
	{
		byd_interfaces_msg_app_currentpark * msg = (byd_interfaces_msg_app_currentpark *)message->data();
		currentParkInfo.CurrentPark.P0_X = msg->CurrentInfo.P0_X;
		currentParkInfo.CurrentPark.P0_Y = msg->CurrentInfo.P0_Y;
		currentParkInfo.CurrentPark.P1_X = msg->CurrentInfo.P1_X;
		currentParkInfo.CurrentPark.P1_Y = msg->CurrentInfo.P1_Y;
		currentParkInfo.CurrentPark.P2_X = msg->CurrentInfo.P2_X;
		currentParkInfo.CurrentPark.P2_Y = msg->CurrentInfo.P2_Y;
		currentParkInfo.CurrentPark.P3_X = msg->CurrentInfo.P3_X;
		currentParkInfo.CurrentPark.P3_Y = msg->CurrentInfo.P3_Y;
		currentParkInfo.CurrentPark.ParkingSpaceValid = msg->CurrentInfo.ParkingSpaceAvailable;
		currentParkInfo.CurrentPark.Width = msg->CurrentInfo.Width;
		currentParkInfo.CurrentPark.ParkingSpaceType = msg->CurrentInfo.ParkingSpaceType;
		currentParkInfo.Angle = msg->CurrentInfo.Angle;
	}
	...
	int data_subscriber(std::string msg)
	{
		...
		auto subscriber_app_currentpark = bclcpp::create_subscription("app/currentpark", &byd_interfaces_msg_app_currentpark_desc, handle_message_test_subscriber_app_currentpark);
		if ((nullptr != subscriber_appstatus)
			...
			&& (nullptr != subscriber_app_currentpark))
		{
